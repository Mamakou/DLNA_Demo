...
- (id)initServerSelfDelegateWithServerName:(NSString *)theServerName {
    NSLog(@"theServerName:%@",theServerName);
...
//    
//    NPT_String uri_path=server->PLT_MediaServer::PLT_DeviceData::m_ModelURL;
//    KFLog(@"%@",[NSString stringWithCString:uri_path encoding:NSUTF8StringEncoding]);
